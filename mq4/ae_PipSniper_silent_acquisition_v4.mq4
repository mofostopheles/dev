/*
   ...
   TRYING TO ISOLATE SQUARE Ms and SQUARE Ws in my custom volume histogram
   ...
   NOTES:
   - open another chart running previous version to check for signal accuracy
...
int init()
{
   ...
   string vsiTitle = "the verge of greatness v.1";
   Sym = Symbol();
...
//***************** BEGIN PATTERN ******************// 
                  ...
                  //{
                     if (
                           strengthBuffer[i+1] > 4000
  
                           //strengthBuffer[i+1] > 0   //FIND nicely formed squared Ws below the 0 line in the volume histogram                     
                        ...
                        )
                     {
                        ...
                        ObjectCreate("buy"+_labelIndex,OBJ_TEXT,0,Time[i+1],minus1CandleLow-((Point*10)*5));
                        ObjectSetText("buy"+_labelIndex, "-X-",14,"Arial",Green);      
                     }
                     else if ( strengthBuffer[i+1] < -4000 )
                     {
                        ObjectCreate("sell"+_labelIndex,OBJ_TEXT,0,Time[i+1],minus1CandleLow-((Point*10)*5));
                        ObjectSetText("sell"+_labelIndex, "-X-",14,"Arial",Red); 
                     }
                 //}    
//***************** END PATTERN ******************// 
