...
//switched some of the i based variables to time-based. this is more scalable and less bug prone.

//this is a great entry finder. the key is tuning up the test parameters
//interesting results when using prime numbers for given tests, limits, prices, etc
...
/* ------------------------- S/R LINES ---------------------------*/
            ...
            //to find resistence lines and prevent entries right under these lines
         	...
         	//macd just flipped to +
      		if (
      	           fiveMinMacdMinus1Candle >= 0
      	           && fiveMinMacdMinus2Candle <= 0
      	           //&& fiveMinMacdMinus3Candle < 0
      	           //&& fiveMinMacdMinus4Candle < 0
      	     )
      	     {
