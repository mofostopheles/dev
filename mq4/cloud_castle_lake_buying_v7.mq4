...
void OnTick()
{
   ...
   //find bears with shaved or near shaved bottoms
   //followed with a bull
   //just to see
   ...
   if (
      ...
      {
         ObjectCreate("turningpoint"+_labelIndex,OBJ_ARROW,0,Time[blockingCandleIndex+j],High[blockingCandleIndex+j]);
         ObjectSet("turningpoint"+_labelIndex, OBJPROP_ARROWCODE, SYMBOL_ARROWDOWN);
         ObjectSet("turningpoint"+_labelIndex,OBJPROP_COLOR,Pink);
      }
