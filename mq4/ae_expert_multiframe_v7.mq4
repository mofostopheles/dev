//based on 34 ema breakout and retest of the wave
//see my email thread: https://mail.google.com/mail/?ui=2&shva=1#drafts/13850747fae761d0

//globally adjust tp/sl
double _stopLossFactor = 12;
double _takeProfitFactor = 36; //dynamically reset depending on the MACD
...
//***************** END LOOKBACK PATTERN SETUP ******************//
  ...
  //first, acquire a target            
	     if (  
	           ...
	           && minus1CandleOpen == minus1CandleLow //shaved bottom breakthrough!!!
	           && average143421MACD > 0
	           
	           //_signalPattern == "xhh|up|x"
		        /*
	            ...
	            && macdAverage > 0 //simple way to trade with the trend
	            */
	     )
	     {	
               //ARM THE WEAPON
      ...
      if (  
               _WEAPON_ARMED == true
               && Time[i+1] - _targetAcquisitionTime >= 600
               && minus1CandleLow <= ( _targetAcquisitionClose - ( _targetAcquisitionHigh - _targetAcquisitionLow)/2)+5*(10*_point)  //test of the extreme
      ...
      if ( 
           ...
           )
           {
               ...
               {        
                  ...
                  {                  
                     ...
                     else
                     {
                        ...
                        _SL=minus1CandleLow;  //_bid-_stopLossFactor*(10*_point);
            ...
            /*------- EXPIRE THE WEAPON IF ACQUISITION LONGER THAN AN Hour -------*/
            if (Time[i+1] - _targetAcquisitionTime >= targetLockExpire)
            {
               _WEAPON_ARMED = false;
               _LOCKED_ON = false;
            }
