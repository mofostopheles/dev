/*
   ...
   using standard deviation crossings of the .0003 line to filter out noise
   
   some of the best entries are illuminated. also some of the worst in that conflicting signals arise. the trick, as always is to reduce s/n.
   find wicky candles at above average volume. 
   this is the smart money stopping out the herd and reversing course.
   it is very important to remember that we are trying to find areas where the herd is being driven off a cliff.
...
string vsiTitle = "double the volume v.5";
