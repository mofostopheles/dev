	...
	if (_lastAlertTime < Time[0] || _firstRun == false) //a candle just opened
   {
      ...
      _labelIndex = 0;
         ...
         for(int i = Bars; i >= 0; i--)
         {
            ...
            double minus1_12SmaHigh = iMA(Sym, TimeFrame, 12, TimeFrame, MODE_SMA, PRICE_HIGH, shift1+1 );
            double minus1_12SmaLow = iMA(Sym, TimeFrame, 12, TimeFrame, MODE_SMA, PRICE_LOW, shift1+1 );
            double minus1_12SmaClose = iMA(Sym, TimeFrame, 12, TimeFrame, MODE_SMA, PRICE_CLOSE, shift1+1 );  
