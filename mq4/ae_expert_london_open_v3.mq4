...
//backtesting previous v.2 with following dataset using buys only yields 262 pips with 9 wins, 13 losses
//current results: 
//arlo emerson - 8/22/2012


string _entryCues[22][2] = {
"8/21/2012", "buy",
"8/16/2012", "sell",
"8/13/2012", "buy",
"6/8/2012", "sell",
...
"8/1/2012", "buy",
"6/11/2012", "sell",
"6/12/2012", "buy", //example of a false positive on the 10 year indicator...and code prevented a trade from occuring
"6/14/2012", "buy",
"5/18/2012", "buy", //example of SL because the move doesn't happen until much later, when local MACD flips up...perhaps write wait and see logic
"4/27/2012", "buy",
"4/19/2012", "buy",
"4/18/2012", "sell",
"4/16/2012", "buy",
...
"3/5/2012", "buy",
"2/23/2012", "buy",
"2/13/2012", "sell" //be careful on mondays. 1st candle was a range and the day's high tested fridays high before plunging
};
...
//***************** BEGIN TARGET ACQUISITION AND ENTRY ******************//      
      ...
      //N pip advance - increase brackets
      if (
            minus1CandleClose >= (_SL + 30*(_point*10))
            && OrdersTotal() == 1
          )
      {  
         
         _SL = NormalizeDouble(_SL + 20*(_point*10), 4);
         _TP = NormalizeDouble(_TP + 60*(_point*10), 4);
