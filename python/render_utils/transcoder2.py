				...
				for output in self.outputs:
					...
					for tune in self.tuneSettings:
						...
						for speed in self.speeds:
							...
							arg = "ffmpeg -analyzeduration 1G -probesize 1G -i " + fileName + " -s " + size + " -c:v libx264 -x264-params \"nal-hrd=cbr\" -pix_fmt yuv420p -probesize 5000000 -b:v " + bitRate + " -minrate " + bitRate + " -maxrate " + bitRate + " -bufsize " + bitRate + " -acodec aac -strict -2 -tune " + tune + " -preset " + speed + " -movflags faststart -y -force_key_frames 1 " + fileName.replace(fileType, "_" + fileDetails + bitRate + ".mp4")
