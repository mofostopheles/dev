...
class MakeSpritesFromFrames():
	...
	def __init__(self):
		...
		parser = argparse.ArgumentParser(description='This script makes a 1 row sprite from PNGs that' + TextColors.WARNING + ' HAVE NOT ' + TextColors.ENDC + 'been output into specific directories. Typically these would have been exported from After Effects as PNGs using ' + TextColors.WHITE + '__render_frames_from_selected_comps.jsx.' + TextColors.ENDC, 
