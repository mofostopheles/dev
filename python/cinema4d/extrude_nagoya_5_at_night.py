...
def makeABuilding( pObj ):
    ...
    if pObj:    
        ...
        if smallBuilding == True:
            tex[c4d.TEXTURETAG_MATERIAL] = doc.SearchMaterial("light_window_6")
        ...
        if tallBuilding == True:
            ...
            hvacStructureSpline[c4d.ID_BASEOBJECT_REL_POSITION,c4d.VECTOR_Z] = height
        ...
        if tallBuilding == True:
            ...
            streetlight = doc.SearchObject("stree3tlight")            
            ...
            tmpStreetlight.InsertAfter(tmpRoof)
        '''
