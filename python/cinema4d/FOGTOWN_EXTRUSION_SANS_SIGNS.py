...
#arlo emerson
#1/23/2015 through ____ 2/28/2015
_counter = 0
...
def makeABuilding( pObj ):
    ...
    if pObj:    
        ...
        if smallBuilding == True:
            tex[c4d.TEXTURETAG_MATERIAL] = doc.SearchMaterial("holograph")
        ...
        roofTex[c4d.TEXTURETAG_MATERIAL] = doc.SearchMaterial("holograph")
        ...
        if tallBuilding == True:
            ...
            tmpTex[c4d.TEXTURETAG_MATERIAL] = doc.SearchMaterial("holograph")
