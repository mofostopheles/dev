...
var LABEL_SWAP_Phone_BUTTON = "Swap Phone";
var MARGIN_LEFT = 50;
var SEARCH_STRING_UI = "_ui_";
var SEARCH_STRING_Phone = "_phone";
...
function buildUI()
{
    if (win != null)
    {
        ...
        //------------------------- PHONE SWAPPING SECTION -------------------------

        var strPhoneSwapping = 
        "panel { orientation:'row', text:'__Phone__ swapper', spacing:5, margins:10, \
            ...
            rightCol: Group { alignment:['fill','fill'], swapButton: Button { text:'" + LABEL_SWAP_Phone_BUTTON + "' , alignment:['fill','fill'], preferredSize:[100, *]}, \
            } \
        }";
        
        win.objPhoneSwapping = win.add(strPhoneSwapping);
        populateLayerList(win.objPhoneSwapping.leftCol.topRow.ddlLayerToSwap);
        populateCompList(win.objPhoneSwapping.leftCol.botRow.ddlCompToSwap, SEARCH_STRING_Phone);
        win.objPhoneSwapping.rightCol.swapButton.onClick = function() { swapItems( win.objPhoneSwapping ) };
        ...
        win.objGlobalButtons.cmds.refreshLayersButton.onClick = function() { populateLayerList(win.objPhoneSwapping.leftCol.topRow.ddlLayerToSwap);populateLayerList(win.objGroup2.leftCol.topRow.ddlLayerToSwap); };
