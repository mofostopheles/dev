...
// swap a layer with something from the project bin
...
function start() 
{
    var replacee = "asdfasdf";
    var replacer = "asdfsadf_v2";
    var layerToReplace = replacee;
    var listOfReplacementComps = [replacer];
